	...
	<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
				...
				<div class="modal-body">
                   <form class="mt-0" id="insertForm" name="insertForm" action="/mbrinsert.do" method="post">
	                      ...
	                      <div class="form-group field-wrapper input test1">
	                      	...
	                      	<button class="btn btn-info mb-2" id="idBtn" type="button">ID중복검사</button>
	                      	<span id="idSpan"></span>
	                      </div>
	                      <div class="form-group field-wrapper input test1">
	                       	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="joinSubmit">가입신청</button>
