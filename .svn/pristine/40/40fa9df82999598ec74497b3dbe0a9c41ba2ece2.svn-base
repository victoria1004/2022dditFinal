    ...
    <div class="action-btn layout-top-spacing mb-5">
        ...
        <c:forEach var="plId" items="${plId}">
        	<c:if test="${mbrId eq plId}">
	        	<button id="add-list" class="btn btn-outline-primary" style="margin-left: 20px;">칸반 추가</button> 
	        </c:if>
        </c:forEach>
    </div>
            ...
            <div class="modal-body">
                <div class="compose-box">
                    <div class="compose-content" id="addTaskModalTitle">
                        <h5 class="add-task-title">칸반 작성하기</h5>
                        <h5 class="edit-task-title" style="display: none;">칸반 수정하기</h5>
                      <div class="card-body">
                              ...
                              <div class="row">
                                  <div class="col-md-12">
                                      <div class="task-title mb-4">
                                          ...
                                          <input id="s-task" type="text" placeholder="제목 입력" class="form-control" name="task">
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="row">
                                  <div class="col-md-12">
                                      <div class="task-badge mb-4">
                                          ...
                                          <textarea id="s-text" placeholder="내용 입력" class="form-control" name="taskText"></textarea>
                                      </div>
                                  </div>
                              </div>
                                  ...
                                  <div class="col-md-12">
                                      <div class="task-badge mb-4">  
	                                      ...
	                                      <div class="form-group mb-0">
                                        		<input id="rangeCalendarFlatpickr" class="form-control flatpickr flatpickr-input sded" type="text" placeholder="기간 선택" readonly="readonly">
                                    	  </div>
              						 </div>
                                  </div>
                               </div>
