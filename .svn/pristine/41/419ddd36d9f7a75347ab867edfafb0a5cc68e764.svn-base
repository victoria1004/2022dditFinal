...
public class QrLoginController {
	...
	private static final Logger logger = 
			LoggerFactory.getLogger(QrLoginController.class);
	
	//QR로그인 처리
	@RequestMapping(value = "/qrlogin.do")
	public String qrLogin(@RequestParam Map<String,Object> param) {
		
		logger.debug("param : {}", param);
		
		return "/login/qrLogin"; 
	}
	
	@RequestMapping("/makeQr.do") 
	public String makeqr(HttpServletRequest request,HttpSession session,String storeName) throws WriterException, IOException { 
	    ...
	    // 링크로 할 URL주소 
	    String url = "localhost/qrLogin.do?store="+storeName; 
