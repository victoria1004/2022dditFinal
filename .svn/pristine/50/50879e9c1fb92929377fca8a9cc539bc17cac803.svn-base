...
var pjtNo=${projectVO.pjtNo};
					...
					success:function(result){
						...
						console.log("member", result);
							for(var i=0;i<result.length;i++){
		        				...
		        				str+="<td id='thirdTd'><div id='roleContent'><span class='badge badge-pills outline-badge-primary'>"+res[i].pjtPrtpntRl+"</span></td>";   
		        				str+="</tr>";
						}
	...
	<div class="layout-px-spacing">
		<div class="leftDiv" style="heigth:auto;" >
	      <!-- CONTENT AREA -->
	      
	
	      <div class="row layout-top-spacing" style="heigth:auto;">
	          <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
	          <form id="making" name="making" action="/project/getAll.do" method="post">
	              <div class="widget-content-area br-4" style="padding-bottom:40px;">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
												    ...
												    <form name="frm" action="#" method="post">
												      ...
												      <button onclick="fn_membering()" type="button" data-dismiss="modal" class="btn btn-outline-primary mb-2">완료</button>
												      </div>
												    </form>
												</div>
											</div>
