...
#insertForm, #findIdForm, #findPwForm{
	width: 88%;
    margin-left: 6%;
}
.swal-text{
...
<body>
		...
		<div class="jb-box">
	    	<video muted autoplay loop>
	        	<source src="/resources/assets/img/Concentric - 69577.mp4" type="video/mp4">
	      	</video>
	    	<div class="jb-text">
	        	<img id="bigLogo" alt="logo.png" src="/resources/assets/img/3 .png">
	      	</div>
	    </div>       
        </div>  
        <div id="loginDiv">
                             ...
                             <div class="form">
                                ...
                                <div id="userId-field" class="field-wrapper input">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
		                     		<form:input path="mbrId" class="form-control test4" placeholder="ID를 입력하세요" maxlength="15" />
                                </div>

                                <div id="password-field" class="field-wrapper input mb-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
		                     		<form:input class="form-control test4" path="mbrPw" placeholder="비밀번호를 입력하세요" type="passWord" id="pwInput" maxlength="15" />
                                </div>
                             </div>
                        </form:form>                        
                                ...
                                <div class="field-wrapper button1">
                                    <button class="btn btn-outline-primary " id="loginBtn" type="button">로그인</button>
                                </div>
                                <br>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="terms-conditions" id="hiddenP">© 2021 All Rights Reserved. <a href="index.html">doIT</a> is a product of Designreset. <a href="javascript:void(0);">Cookie Preferences</a>, <a href="javascript:void(0);">Privacy</a>, and <a href="javascript:void(0);">Terms</a>.</p>
                            </div>
...
function toggle(element){ //패스워드 보이기/숨기기
	//console.log(element.checked);
	var mbrPw = $('#pwInput').val();
	 if (element.checked) {        
		 mbrPw.type = 'text';      
     } else {                    
    	 mbrPw.type = 'password';   
	 ...
	 $.ajax({
		...
		success : function(data) {
			...
			if(data.sta=="success"){
				...
				swal({
				  title: "",
				  html: "가입 신청이 완료되었습니다.<br>가입 승인 후 로그인해주세요.",
				  //icon: '${type}',
				  button: '${button}'
			})
			}else{
