...
<!-- 					<div class="widget-header" > -->
							<div class="col-lg-12 layout-top-spacing">
								<button class="btn btn-outline-primary" style="float: right; margin-top:5px; margin-right: 20px;" onclick="location.href='/project/reportInsert.do?pjtNo=${project.pjtNo}'">업무보고 작성</button>
								<div class="row">
								...
								<table class="multi-table table table-hover dataTable"
									...
									<thead>
										<tr role="row">
											<th tabindex="0"
												style="width: 140px;">작성일</th>
											<th tabindex="0"
												style="width: 140px;">구분</th>
											<th tabindex="0"
												style="width: 350px;">제목</th>
											<th tabindex="0"
												style="width: 140px;">작성자</th>
											<th tabindex="0"
												style="width: 140px;">상태</th>
										</tr>
									</thead>
									<tbody>
											...
											<tr role="row">
												...
												<td style="text-align:center;">
														<c:if test="${rep.RPT_STTS eq null}">
															<span class="badge badge-pills outline-badge-success">승인대기</span>
														</c:if>
														<c:if test="${rep.RPT_STTS eq 'C'}">
															<span class="badge badge-pills outline-badge-primary">승인</span>
														</c:if>
														<c:if test="${rep.RPT_STTS eq 'R'}">
															<span class="badge badge-pills outline-badge-danger">반려</span>
														</c:if>
												</td>
											</tr>
