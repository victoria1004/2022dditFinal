...
<script>
	...
	function setting(){
		$('#pjtName').val('알바지옥');
		$('#pjtLayout').val('소통형 구직 사이트');
		$('#pjtExplain').val('공고를 등록하여 아르바이트 지원자를 모집하고, 채팅으로 면접을 보는 등 실시간 양방 소통형 구직 사이트를 구축한다');
	          ...
	          <form id="making" name="making" action="/project/getAll.do" method="post">
	              ...
	              <br><br>
	                  <div class="widget-one">
	                  	<label onclick="setting()" class="p_lab" id="nameLabel" for="pjtName">프로젝트명</label>  &nbsp;&nbsp;
	                   ...
	                   <div class="widget-one">
	                  	<label class="p_lab" id="explainLabel" for="pjtExplain">프로젝트 기간</label>  &nbsp;&nbsp;
	                  		...
	                  		<div class="form-group mb-0">
                                <input name="pjtStrtYmd" id="rangeCalendarFlatpickr" class="form-control flatpickr flatpickr-input" type="text" placeholder="프로젝트 기간을 설정하세요" readonly="readonly">
                            </div>
	                  	
	                  </div><br><br>
	            
	            
	            	   <p id="select">모듈은 이후 수정할 수 없습니다</p>
		               <div class="widget-one">
		            		<label class="p_lab" id="moduleLabel">사용 모듈 설정</label>  &nbsp;&nbsp;
		            		
							 <div class="n-chk">
							    <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
							      <input type="checkbox" class="new-control-input" id="lytNo" value="L01">
							      <span class="new-control-indicator"></span><span class="new-chk-content">간트차트</span>
							    </label>
							</div>
							...
							<div class="n-chk">
							    <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
							      ...
							      <span class="new-control-indicator"></span><span class="new-chk-content">일정</span>
							    </label>
							</div>
							...
							<div class="n-chk">
							    <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
							      ...
							      <span class="new-control-indicator"></span><span class="new-chk-content">칸반</span>
							    </label>
							</div>
							...
							<div class="n-chk">
							    <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
							      ...
							      <span class="new-control-indicator"></span><span class="new-chk-content">피드</span>
							    </label>
							</div>
							...
							<div class="n-chk">
							    <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
							      ...
							      <span class="new-control-indicator"></span><span class="new-chk-content">이슈</span>
							    </label>
							</div>
	            	  </div><br>
	            	  
	            	  <div class="issue" style="display:none;">
		            	  <p id="select">이슈 모듈에서 사용할 마커를 만들어보세요! </p>
		            	  <div class="issueMarker">
			            	  <div class="widget-one">
			                  	<label class="p_lab" id="makerLabel">이슈 마커</label>  &nbsp;&nbsp;
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h5 class="modal-title" id="tabsModalLabel">이슈 마커 생성</h5>
                                          ...
                                          <div class="modal-body">
                                                <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">마커명</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="aaa-tab" data-toggle="tab" href="#aaa" role="tab" aria-controls="aaa" aria-selected="false">색상</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="true">아이콘</a>
                                                    </li>
                                                </ul>
                                              <div class="tab-content" id="myTabContent">
                                                  
                                                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                        	<label class="nameLabel" id="nameLabel">마커 이름</label>
                                                        	<form id="fm_name">
                                                  ...
                                                  <div class="tab-pane fade" id="aaa" role="tabpanel" aria-labelledby="aaa-tab">
                                                         <div id="box" class="box">
															 ...
															 <div id="cvText"><label>마커 색상 미리보기</label></div>
                                                  ...
                                                  <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                                    ...
                                                    <div id="cvText2"><label>마커 색상 미리보기</label></div>
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="fn_mkFin()">확인</button>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
	               ...
	               <p id="select">프로젝트 멤버는 최대 10명입니다</p>
	               <div class="widget-one">
	                  	...
	                  	<div id="membering">
						    ...
						    <label class="new-control new-checkbox new-checkbox-text checkbox-primary" id="recruitment">
						      ...
						      <c:if test='${me.mbrCtgrCd=="M02"}'>
					        		<span class="new-control-indicator"></span><span class="new-chk-content">추후모집</span>   
					        </c:if>
 ...
 <div class="modal fade show" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" style="display: none; padding-right: 17px;" aria-modal="true">
	<div class="modal-dialog modal-dialog-centered" role="document" style="width: 380px;">
    	...
    	<div class="modal-content">
        	<div class="modal-header">
            	<h5 class="modal-title" id="exampleModalCenterTitle">프로젝트 멤버 추가</h5>
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				...
				<div class="widget-content searchable-container list" style="height : 430px; margin-top : 20px;">
					...
					<form name="frm" action="#" method="post">
				      	...
				      	<div style="height : 50px; width : 330px; text-align : right;" id="finishBtn">
							<button onclick="fn_membering()" type="button" class="btn btn-outline-primary mb-2">완료</button>
						</div>
			    	</form>		
				</div>
			</div>
                                 ...
                                 <div id='bottomZone' style="display:flex;">                      
		                                 <div class="lang">
			                                 <p id="select" style="display:inline-block;">개발에 쓰일 언어를 선택해주세요</p>
											...
											<div class="key" style="display:none; margin-left:30px; text-align:center;">
												<p id="select" style="display:inline-block; margin-left:179px;">프로젝트 검색 필터링에 포합됩니다</p>
													<div class="widget-one" style="height:50px;">
													  <label class="p_lab" style="margin-left:160px;">키워드</label>  &nbsp;&nbsp;
										 ...
										 <br /><br /><br />
										  <div style="height:50px;">
										  	<div style="float:right; margin-right:40px;">
				                           		<button type="button" class="btn btn-outline-primary mb-2">취소</button>&nbsp;
				                           		<button type="button" onclick="allFin()" class="btn btn-outline-primary mb-2">완료</button>
				                           	</div>	
			                              </div>
						    	<br /><br />
                              </div>
						              ...
						              <div class="modal fade bd-example-modal-sm" id="keywordModal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" style="display: none;" aria-hidden="true">
                                        <div class="modal-dialog modal-sm" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="mySmallModalLabel">키워드</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                               		 <label class="keywordLabel" id="keywordLabel">키워드명</label>
                                                        	<form id="fm_name">
				               ...
				               <div class="modal fade show" id="logoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" style="display: none; padding-right: 17px;" aria-modal="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="logoModalTitle">개발언어 설정</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                                                    </button>
                                                </div>
												...
												<ul class="list-group list-group-media" id="logoList">
												      ...
												      <button onclick="fn_logoFin()" type="button" data-dismiss="modal" class="btn btn-outline-primary mb-2">완료</button>
												      </div>
