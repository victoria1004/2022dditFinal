	          ...
	          <form id="making" name="making" action="/project/getAll.do" method="post">
	              ...
	              <br><br>
	                  <div class="widget-one">
	                   ...
	                   <div class="widget-one">
	                  	<label class="p_lab" id="explainLabel" for="pjtExplain">프로젝트 기간 설정</label>  &nbsp;&nbsp;
	                  
	                  		<div class="form-group mb-0">
                                <input name="pjtStrtYmd" value="hello${projectVO.pjtStrtYmd}${projectVO.pjtEndYmd}" id="rangeCalendarFlatpickr" class="form-control flatpickr flatpickr-input" type="text" placeholder="프로젝트 기간을 설정하세요" readonly="readonly">
                            </div>
                                 ...
                                 <div id='bottomZone' style="display:flex;">                      
		                                 <div class="lang">
											...
											<c:if test="${projectVO.pjtRcrtStts=='N'}">
												...
												<p id="select" style="display:inline-block; margin-left:170px;">프로젝트 검색 필터링에 포합됩니다</p>
													<div class="widget-one" style="height:50px;">
													  <label class="p_lab" style="margin-left:151px;">키워드</label>  &nbsp;&nbsp;
										  ...
										  <div style="height:50px;">
										  	<div style="float:right; margin-right:20px; margin-top:20px;" >
				                           		...
				                           		<button type="button" onclick="allFin()" class="btn btn-outline-primary mb-2">수정</button>
				                           	</div>	
			                              </div>
						    <br><br>
                              </div>
