...
public class ArticlePage {
	...
	// 생성자
	// size : 한 화면에 보여질 행의 수
	public ArticlePage(int total, int currentPage, int size, int pagingCount, List<LogVO> content) {
		this.total = total;
	...
	public List<LogVO> getContent() {
		return content;
	}


	public void setContent(List<LogVO> content) {
		this.content = content;
	}
