...
<head>
    ...
    <link href="/resources/assets/css/authentication/form-2.css" rel="stylesheet" type="text/css" />
...
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">회 원 가 입</h1>
                        <p class="signup-link register">이미 회원이신가요?<a href="/login.do">로그인창으로</a></p>
                            ...
                            <div class="form">
								...
								<div id="password-field" class="field-wrapper input mb-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="auth_pass_recovery_boxed.html" class="forgot-pass-link">비밀번호찾기</a>
                                    </div>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <button type="submit" class="btn btn-primary" value="">가입완료</button>
                                    </div>
                                </div>
    ...
    <script src="/resources/assets/js/authentication/form-2.js"></script>
