								...
								<div class="col-md-8 col-12">
									<div class="labels">
										<label id="personal"><input type="checkbox"
											...
											onclick="checkOnly(this)"> 개인</label> <label id="conference"><input
											type="checkbox" id="filter_c" name="filter" value="C02"
											onclick="checkOnly(this)"> 회의</label> <label id="important"><input
											type="checkbox" id="filter_i" name="filter" value="C03"
											onclick="checkOnly(this)"> 중요</label>
									</div>
								</div>
																	...
																	<table>
																		...
																		<tbody>
																			<tr>
																				...
																				<td></td>
																				<td></td>
																				<td class="fc-event-container" colspan="2"><a class="fc-day-grid-event fc-h-event fc-event fc-start fc-end bg-danger fc-draggable" id="event-1" data-original-title="" title=""><div class="fc-content"><span class="fc-time">2:30p</span> <span class="fc-title">요구사항 분석 컨펌 받기</span></div></a></td>
																			</tr>
																		</tbody>
																	</table>
																</div>
																...
																<div class="fc-content-skeleton">
																	<table>
																		...
																		<tbody>
																			<tr>
																				<td></td>
																				<td class="fc-event-container"><a class="fc-day-grid-event fc-h-event fc-event fc-start fc-end bg-danger fc-draggable" id="event-10" data-original-title="" title=""><div class="fc-content"><span class="fc-time">8:12a</span> <span class="fc-title">산출물 모두 업로드</span></div></a></td>
																				<td></td>
																				<td></td>
																				<td class="fc-event-container"><a class="fc-day-grid-event fc-h-event fc-event fc-start fc-end bg-warning fc-draggable" id="event-7" data-original-title="" title=""><div class="fc-content"><span class="fc-time">5:30a</span> <span class="fc-title">착수발표 회의</span></div></a></td>
																			</tr>
																		</tbody>
																	</table>
																</div>
																	...
																	<table>
																		...
																		<tbody>
																			<tr>
																				...
																				<td class="fc-event-container" colspan="3"><a class="fc-day-grid-event fc-h-event fc-event fc-start fc-end bg-primary fc-draggable" id="event-2" data-original-title="" title=""><div class="fc-content"><span class="fc-time">7:30p</span> <span class="fc-title">도우너와 점심 약속</span></div></a></td>
																				<td rowspan="5"></td>
																				<td rowspan="5"></td>
																				<td rowspan="5"></td>
																			</tr>
									...
									<form name="cal" action="/project/calendar.do" method="post">
													...
													<div class="d-sm-flex d-block">
														<div class="n-chk">
															<label class="new-control new-radio radio-primary">
																...
																class="new-control-indicator"></span>개인
															</label>
														</div>
														...
														<div class="n-chk">
															<label class="new-control new-radio radio-warning">
																...
																class="new-control-indicator"></span>회의
															</label>
														</div>
														...
														<div class="n-chk">
															<label class="new-control new-radio radio-danger">
																...
																class="new-control-indicator"></span>중요
															</label>
														</div>
										...
										<div class="modal-footer">
											...
											<button
												...
												type="button" id="add-e" class="btn">확인</button>
											<button id="edit-event" class="btn btn-outline-primary mb-2">확인</button>
										</div>
										<sec:csrfInput />
									</form>
								</div>
