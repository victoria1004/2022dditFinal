...
$(function(){
	...
	getAllApplicant(mbrId); //내가 작성한 프로젝트에 신청한 사용자 목록
            ...
            <div class="row" style="width:95%; position: relative; left:40px;">
                ...
                <h5>참여 신청목록</h5>
					<table class="table">
                      <thead>
	                          <tr>
	                              <th style="padding-left:56px;"><div class="th-content">이름</div></th>
	                              <th style="padding-left:2px;"><div class="th-content">소속</div></th>
	                              <th><div class="th-content th-heading">프로젝트명</div></th>
	                              <th><div class="th-content" style="position: relative; right: 19px;">신청일</div></th>
	                          </tr>
	                      </thead>
	                  </table>
                ...
                <table class="table">
                      <thead>
	                          <tr><th><div class="th-content" style="position: relative; right: 102px;">신청자의 정보</div></th>
...
<!-- 	                  <button class="btn btn-outline-danger mb-2">거절</button>&nbsp;&nbsp; -->
<!-- 	                  <button class="btn btn-outline-success mb-2">승인</button> -->
<!-- 	                </div> -->
	             </div>
                </div>
                <div id="memberList" class="col-sm-6 member">
                <h5 id="pjtHeader">프로젝트 구성원</h5>
                <table class="table">
                      <thead>
	                          <tr>
	                              <th><div class="th-content" style="padding-left:59px;position: relative; right: 18px;">이름</div></th>
	                              <th><div class="th-content" style="position: relative; right: 60px;">소속</div></th>
	                              <th><div class="th-content th-heading" style="position: relative; right: 79px;">전화번호</div></th>
	                              <th><div class="th-content" style="position: relative; right: 71px;">역할</div></th>
	                          </tr>
	                      </thead>
	             </table>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body" style="height: auto; text-align: center;">
				<p style="font-size: 16px; color: #3b3f5c;" >신청자에게 역할을 부여해주세요.</p>
				<br /><br />
