 ...
 * @author 이영지(슈퍼개발자K3)
 */
package kr.or.ddit.project.server;
...
@ServerEndpoint(value = "/header/usersServerEndpoint"/* ,configurator=ServerAppConfig.class */)
public class UsersServerEndPoint4Header {
	private static final Logger LOGGER = LoggerFactory.getLogger(UsersServerEndPoint4Header.class);
	...
	public void handleOpen(Session userSession) {
		...
		LOGGER.info("-----헤더꺼 size:" + connectedAllUsers.size());
	}
